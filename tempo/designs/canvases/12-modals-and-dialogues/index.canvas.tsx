...
export const Cover: TempoStoryboard = {
  ...
  name: "00 · Cover",
  layout: { x: -63, y: 0, width: 1406, height: 351 },
};
...
export const Anatomy: TempoStoryboard = {
  ...
  name: "01 · Anatomy",
  layout: { x: 1423, y: 0, width: 1280, height: 1707 },
};
...
export const Sizes: TempoStoryboard = {
  ...
  name: "02 · Sizes",
  layout: { x: 2660, y: 0, width: 1280, height: 2272 },
};
...
export const HavnModals: TempoStoryboard = {
  ...
  layout: { x: 3990, y: 0, width: 1280, height: 2757 },
};
