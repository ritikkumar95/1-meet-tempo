...
export const Cover: TempoStoryboard = {
  ...
  name: "00 · Cover",
  layout: { x: -218, y: 0, width: 1406, height: 351 },
};
...
export const CardsGroup: TempoStoryboard = {
  ...
  name: "04 · Cards",
  layout: { x: 5320, y: 0, width: 1280, height: 2303 },
};
...
export const SearchBarShowcase: TempoStoryboard = {
  ...
  name: "02 · SearchBar",
  layout: { x: 2660, y: 0, width: 1280, height: 2908 },
};
...
export const FilterChipShowcase: TempoStoryboard = {
  ...
  name: "03 · FilterChip",
  layout: { x: 3990, y: 0, width: 1280, height: 1187 },
};
...
export const NavbarShowcase: TempoStoryboard = {
  ...
  name: "01 · Navbar",
  layout: { x: 1330, y: 0, width: 1280, height: 1335 },
};
...
export const RatingStarsShowcase: TempoStoryboard = {
  ...
  name: "05 · RatingStars",
  layout: { x: 6650, y: 0, width: 1280, height: 1393 },
};
...
export const HeartButtonShowcase: TempoStoryboard = {
  ...
  name: "06 · HeartButton",
  layout: { x: 7980, y: 0, width: 1280, height: 1384 },
};
