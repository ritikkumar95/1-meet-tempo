...
export const Cover: TempoStoryboard = {
  ...
  name: "00 · Cover",
  layout: { x: -157, y: 0, width: 1406, height: 351 },
};
...
export const Anatomy: TempoStoryboard = {
  ...
  name: "01 · Anatomy",
  layout: { x: 1330, y: 0, width: 1280, height: 1062 },
};
...
export const States: TempoStoryboard = {
  ...
  name: "02 · States",
  layout: { x: 2660, y: 0, width: 1280, height: 2663 },
};
...
export const Affixes: TempoStoryboard = {
  ...
  name: "03 · Affixes",
  layout: { x: 3990, y: 0, width: 1280, height: 1520 },
};
...
export const Types: TempoStoryboard = {
  ...
  name: "04 · Types",
  layout: { x: 5320, y: 0, width: 1280, height: 2622 },
};
...
export const InSitu: TempoStoryboard = {
  ...
  name: "05 · In situ",
  layout: { x: 6650, y: 0, width: 1280, height: 2459 },
};
